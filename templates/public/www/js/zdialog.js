...
;(function ($, window, document, undefined) {
    //默认参数
    var PARAMS;
    var DEFAULTPARAMS = {Title: "", Content: "", BtnL: "", BtnR: "", FunL: new Object, FunR: new Object};
    $.DialogByZ = {
        //弹出提示框
    ...
    function loadBox(Url) {
        var url = Url;
        var dislogContainer = $('<div class="zbox-popup" style="display: block;"><div class="zbox-load"><img  id="zchange" src="' + url + '"><p>加载中...</p></div></div>');
    ...
    function Show(params, caller) {
        ...
        if (caller == 'Autofade') {
            ...
            $("body").append(blackFilter, dislogContainer);
